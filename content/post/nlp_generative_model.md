...
The results of using Gumbel-softmax seems help GAN in discrete space. As demonstrated Fig 1 clipped from the original paper, the left plot shows the samples generated by MLE and the right one is generated by proposed method. Each row is a sample and we can see the 4th,
## Policy gradient
