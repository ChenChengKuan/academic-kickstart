...
Standard GAN needs the differential operation on the input data thus applying it to discrete input data is difficult. With the reformulation of learning objective or use pretraining to facilitate the learning. Is there any generative model that naturally fit the discrete input data?<a name="bp8"></a>
***
